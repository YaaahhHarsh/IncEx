...
export const INITIAL_GROUPS = [
  {
    ...
    members: [
      { id: "mem-1", name: "You (Alex)", email: "alex@gmail.com", avatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80" },
    ...
    expenses: [
      {
        ...
        date: "2026-08-11",
        splitType: "equal",
        splits: { "mem-1": 4000, "mem-2": 4000, "mem-3": 4000 }
      },
      {
        id: "spex-2",
        ...
        date: "2026-08-12",
        splitType: "equal",
        splits: { "mem-1": 1000, "mem-2": 1000, "mem-3": 1000 }
      }
    ],
    chats: [
      { id: "chat-1", senderId: "mem-2", senderName: "Rohan", text: "Hey guys! I booked the scooters for tomorrow 🛵", timestamp: "10:15 AM" },
      { id: "chat-2", senderId: "mem-1", senderName: "You (Alex)", text: "Awesome! Added the resort booking to Spendly bill splitter 👍", timestamp: "10:18 AM" },
